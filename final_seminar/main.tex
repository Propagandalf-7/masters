...
\setbeamertemplate{title page}{
    \begin{center}
        ...
        \vskip1em%
        \includegraphics[width=0.4\linewidth]{logo-up.jpg}\par % Include the logo here
        \vskip1em\par
...
\section{Numerical Results}
    ...
    \subsection{Validity of the Timoshenko beam}
        ...
        \begin{frame}{Validity of the Timoshenko beam - Results for different beam shapes}
            ...
            \only<2->{
                ...
                \begin{itemize}
                    \item The Timoshenko beam model compares well with the two-dimensional beam model. It is a suitable model to use instead of the two-dimensional beam model.
    ...
    \subsection{Validity of the Two-dimensional beam}
        \begin{frame}{Validity of the Two-dimensional beam - Visual representation}
            \begin{center}
                \begin{minipage}[b]{0.45\linewidth}
                    \centering
