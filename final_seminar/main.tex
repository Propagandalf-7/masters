...
\section{Literature study}
    \subsection{Comparison of linear beam theories}
        ...
        \begin{frame}{Detailed Comparison: Timoshenko Beam Model vs. Two-Dimensional Model}

            \textbf{Objective of Comparison:}
            \begin{itemize}
              \item To validate the efficacy of the Timoshenko beam theory against a more comprehensive two-dimensional model, which accounts for plane stress conditions and detailed stress distribution across the beam's cross-section.
            \end{itemize}
            
            \textbf{Methodology:}
            \begin{itemize}
              \item Utilized finite element methods to calculate natural frequencies and modes, providing a direct comparison of results from both models.
              \item Both models analyzed under the same boundary conditions and loading scenarios to ensure consistency in comparison.
            \end{itemize}
            
            \textbf{Key Findings:}
            \begin{itemize}
              \item \textbf{Close Agreement}: Timoshenko model results closely match those from the two-dimensional model, with most eigenvalues showing less than 3\% deviation.
              \item \textbf{Model Reliability}: Demonstrates high reliability of the Timoshenko model for predicting beam behavior under various loading conditions, particularly for lower vibration modes.
            \end{itemize}
            
        \end{frame}
            
        \begin{frame}
            \textbf{Model Advantages:}
            \begin{itemize}
              \item \textbf{Timoshenko Model}: Offers significant improvements in accuracy over simpler models like Euler-Bernoulli, especially in scenarios where beam lengths are relatively short and shear deformations cannot be ignored.
              \item \textbf{Two-Dimensional Model}: Provides a more rigorous analysis by accounting for two-dimensional stress effects, which are important for comprehensive structural analyses.
            \end{itemize}
            
            \textbf{Practical Implications:}
            \begin{itemize}
              \item \textbf{Engineering Applications}: Timoshenko model is particularly advantageous for practical engineering applications, providing a good balance between computational efficiency and accuracy.
              \item \textbf{Advanced Analyses}: For critical engineering tasks where detailed stress distribution is crucial, the two-dimensional model serves as a more suitable analytical tool.
            \end{itemize}
            
            \textbf{Conclusions and Recommendations:}
            \begin{itemize}
              \item \textbf{Preferred Use of Timoshenko Model}: Recommended for most practical engineering applications involving beams, where it strikes an optimal balance between accuracy and simplicity.
              \item \textbf{When to Use Two-Dimensional Model}: Advisable for in-depth structural analyses where precise stress distribution is required, such as in complex assemblies or where materials with varying properties are involved.
              \item This comparison serves as an intermediate step towards the more comprehensive analysis involving the comparison of two-dimensional and three-dimensional models.
            \end{itemize}
    ...
    \subsection{Empirical comparison of beams}
        \begin{frame}{Literature study - Empirical comparison of beams}
            Consider the article \textit{On the valid frequency range of Timoshenko beam theory} [\cite{SP06}]\footfullcite{SP06}
        \end{frame}

        \begin{frame}{Setup and Testing Method}
            \textbf{Objective:}
            \begin{itemize}
                \item To validate the frequency predictions of Timoshenko beam theory (TBT) for different end conditions and frequencies.
            \end{itemize}
        ...
        \begin{frame}{Numerical Results and Discussion}
            ...
            \begin{itemize}
                ...
                \item Above the cut-off frequency, TBT predictions deviate increasingly from measured and simulated frequencies.
            \end{itemize}
        
            \textbf{Discussion:}
            \begin{itemize}
                \item For free-free end conditions, discrepancies arise above the cut-off frequency, suggesting limitations in the TBT's applicability.
                \item TBT predictions were increasingly inaccurate for higher modes (n >= 8), exceeding the typical engineering tolerance.
            \end{itemize}
        
            \textbf{Conclusion:}
            \begin{itemize}
                \item The study suggests a cut-off frequency as a reasonable upper bound for TBT predictions.
                \item This research serves as an intermediate step, setting the stage for further comparison between two-dimensional and three-dimensional models.
            \end{itemize}
        \end{frame}
            ...
            \begin{table}[htbp]
                ...
                \makebox[\textwidth]{
                    \begin{tabular}{|cc|cc|cc|cc||cc|}
                        \hline
                        \multicolumn{10}{|c|}{Eigenvalues for $b \leq h$} \\
                        \hline
                        \hline
