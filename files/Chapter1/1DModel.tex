...
\begin{document}
    ...
    \subsection{Equations of motion and constitutive equations}\label{subsec:equationsofmotion+constitutiveequation}
    In this section we introduce the Timoshenko beam theory for the transverse vibration of a uniform beam.
    For a reference of the model~\cite{Timo21}, and~\cite{Fung65} were used.\\

    Consider a beam defined on the interval $[0,\ell]$.
    ...
    \end{align}\label{sym:A}\label{sym:V}\label{sym:Iinertia}\label{sym:M}\label{sym:phiT}
