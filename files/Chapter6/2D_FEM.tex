...
Consider a two-dimensional elastic body clamped rigidly to a surface at $x_1 = 0$. The body is free-hanging on the other boundaries This is referred to as Problem 2D-1 in section \ref{ssec:2D_Model:ModelProblem}.
\FloatBarrier
\begin{figure}[h!]
	\centering
	\begin{tikzpicture}
