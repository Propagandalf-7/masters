...
In this section, the validity of the Timoshenko beam model is investigated. Specifically, the validity of a cantilever Timoshenko beam model, using a cantilever two-dimensional beam model as a reference. This is a discussion and a replication of numerical results of the work done in the article \cite{LVV09}.

The article \cite{LVV09} is titled `Comparison of linear beam theories'. In this article, the authors compare a cantilever Timoshenko beam to a cantilever two-dimensional beam. \textcolor{red}{Give a brief summary of the article here, linking to whatever has already been discussed in the literature review.}

\subsection{The models}
The following two models are the focus of this section and the models that are used in the article \cite{LVV09}. From section \ref{ssec:1D_Model:ModelProblems}, the cantilever Timoshenko beam model, referred to as Problem T-2. From section \ref{ssec:2D_Model:ModelProblem}, the cantilever two-dimensional beam model, referred to as Problem 2D-1.\\
...
In section \ref{sec:Timo:EigenvalueProblem} a method for calculating the eigenvalues and eigenvectors of the Timoshenko beam is provided. And in section \ref{sec:Timo:Cantilever}, the eigenvalues and eigenvectors of a cantilever Timoshenko beam are calculated as an example. These can also be obtained to a desired level of accuracy.
...
In this form, the eigenvalue problem is a system of ordinary differential equations, and can be solved using a numerical method. 
...
For the two-dimensional beam, the shape of the cross-section can deform into a s-shape. This is explained in \cite{LVV09} and a similar figure in \cite{LVV09} is given here. This is a difference between the two models that are inherent to their definitions.\\
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={Relative Error of Eigenvalues for Different Values of Alpha},
            xlabel={Eigenvalue},
        ...
        % Alpha = 300
        \addplot coordinates {
            (1,0.4875) (2,1.1106) (3,0) (4,1.7895) (5,2.4560) (6,0) (7,2.9630) (8,1.4324) (9,0) (10,2.9530)
            (11,0.5735) (12,0) (13,0.8375) (14,0.5643) (15,0) (16,0.4757) (17,0) (18,1.1240) (19,0) (20,1.9740)
        };
        \addlegendentry{\(\alpha = 300\)}
        
        % Alpha = 1200
        \addplot coordinates {
            (1,0.2337) (2,0.4217) (3,0) (4,0.7198) (5,1.0738) (6,1.4507) (7,0) (8,1.6244) (9,2.1618) (10,0)
            (11,2.4560) (12,0) (13,2.7265) (14,0) (15,0) (16,5.2392) (17,0) (18,3.2823) (19,3.0864) (20,0)
        };
        \addlegendentry{\(\alpha = 1200\)}
        
        % Alpha = 4800
        \addplot coordinates {
            (1,0.1125) (2,0.1661) (3,0.2574) (4,0) (5,0.3824) (6,0.5373) (7,0.7065) (8,0) (9,0.9950) (10,1.0740)
            (11,0) (12,1.2680) (13,1.4507) (14,0) (15,0) (16,1.8120) (17,0) (18,1.9850) (19,2.1618) (20,0)
        };
        \addlegendentry{\(\alpha = 4800\)}
        
        % Alpha = 10800
        \addplot coordinates {
            (1,0.0841) (2,0.1009) (3,0.1287) (4,0.2052) (5,0.3824) (6,0.2817) (7,0.3725) (8,0.4712) (9,0) (10,0.5940)
            (11,0.7005) (12,0.8140) (13,0.9307) (14,0) (15,0) (16,1.8120) (17,1.2150) (18,1.9850) (19,2.1618) (20,2.8860)
        };
        \addlegendentry{\(\alpha = 10800\)}
        
        \end{axis}
    \end{tikzpicture}
    \caption{Plot of the relative error for each eigenvalue and each value of \(\alpha\).}
