...
In section \ref{ssec:3D_Model:VariationalForm}, the variational problem for the three-dimensional cantilever model is defined by Problem 3D-1V. For convenience, the relevant results from section \ref{ssec:3D_Model:VariationalForm} are repeated.
