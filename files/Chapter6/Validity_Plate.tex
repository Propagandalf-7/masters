...
For the comparisons, the investigation will consider a plate with small width $b = 0.25$, a plate of width equal to lenght $b = 1$ and a wide plate $1.75$. For each case, decreasing values of the height $h$ will be considered.
...
The next table, table \ref{tab:Table_plate_2}, shows the comparison of the eigenvalues for a plate of width equal to its length, $b = 1$.
...
\begin{table}[htbp]
	...
	\makebox[\textwidth]{
		...
		\begin{tabular}{|cccc||cccc||cccc||cccc|}
			...
			{i} & {3D} & {j} & {Plate} & {i} & {3D} & {j} & {Plate} & {i} & {3D} & {j} & {Plate} & {i} & {3D} & {j} & {Plate} \\
			\hline
			1 & 0.13062 & 1 & 0.12939 & 1 & 0.034245 & 1 & 0.034079 & 1 & 0.0086697 & 1 & 0.32670086456 & 1 & 0.0038626 & 1 & 0.0038541\\
