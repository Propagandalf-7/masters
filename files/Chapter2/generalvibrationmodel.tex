...
\begin{flalign}
	T_n(t) &=  A_n \cos(\omega_n t) + B_n \sin(\omega_n t) \quad \textrm{ if } \lambda > 0, \label{lambda_1}\\
	T_n(t) &=  A_n + B_n t \quad \textrm{ if } \lambda = 0, \label{lambda_2}\\
	T_n(t) &=  A_n \cosh(\mu_n t) + B_n \sinh(\mu_n t) \quad \textrm{ if } \lambda < 0. \label{lambda_3}
\end{flalign}
