...
\end{Poincare_2}
\begin{proof}
	\textcolor{red}{Inlas 41A. Inlas 41B. Theorem 1.}
\end{proof}
...
To understand what is meant by modal analysis, it is in the first place necessary to consider modes of vibration. And to understand how modal analysis is applied, a Timoshenko beam is used as an example. Specifically, Problem T-1. \textcolor{red}{******* WHY NOT T-2???}\\
...
Kan sien met substituting, meer 
...
Simple substitution confirms that the trial solution satisfies the partial differential equations and the boundary conditions for Problem T-1.\\ 

As w en phi kan 2.4.1 en () dan sal .... nie nodig nie. Probeer so ver as moontlik nie seperation of variables gebruik nie. Se eerder oof w en phi is sin en cos\\
