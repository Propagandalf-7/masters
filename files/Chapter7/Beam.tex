...
In the article \cite{LVV09}, the authors show that the Timoshenko beam theory is a feasible model to use in practical applications of beams. In this section, the article is studied and the results are replicated.
