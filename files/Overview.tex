...
In the first chapter, the various models of this dissertation are presented. The models consist of 


The models consist of three-dimensional, two-dimensional and one-dimensional models. For the three-dimensional model, a cantilever and a free-free elsatic body are used. The general case of plane stress is also discussed. As a result of a special case of plane stress, a two-dimensional cantilever elastic body is obtained. For the one dimensional model, the Timoshenko beam theory is considered. The beam models for the Timoshenko beam are a cantilever, free-free, pinned-pinned and a suspended beam models. Finally a Reissner-Mindlin plate model is given. For this plate, the models are a cantilever and a rigidly clamped plate. The variational form of the models are derived.
