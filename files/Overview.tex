...
In this chapter, some theory for the Finite Element Method is discussed. This chapter contains two parts, that covers two different theoretical results. The first is on the convergence of the Galerkin approximation of a general vibration problem. This theory is presented in the article \cite{BV13}. The second part concerns the convergence of the eigenvalues and eigenfunctions of a vibration problem when applying the Finite Element Method. This theory is presented in the textbook \cite{SF73}\textcolor{red}{Nie goed genoeg vir dinamiese probleem}. 
...
\textcolor{red}{*************Copy van chapter 6******************}
