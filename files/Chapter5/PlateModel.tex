...
\textbf{Remark} The mathematical definition of $R_2$ is the same as the two-dimensional beam. Practically, it is not the same. The plate model is a horisontal two-dimensional plane, and the two-dimensional beam is a vertical two-dimensional plane.
...
\begin{figure}[h!]
	...
	\end{tikzpicture}
	\caption{Two-dimensional Cantilever Plate}
\end{figure}
\FloatBarrier
